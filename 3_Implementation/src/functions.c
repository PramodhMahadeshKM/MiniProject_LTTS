...
condition FLP(input_val* params)
{
    ...
    FLP_result1->R1=1;
    FLP_result1->R2=(params->Af-1)*FLP_result1->R1;
    FLP_result1->R=10;
    FLP_result1->C=((1/ (2 * pi * FLP_result1->R * params->freq)) * 1000);

    FLP_result2->R1=10;
    FLP_result2->R2=(FLP_result2->R1)*(params->Af);
...
condition SLP(input_val* params)
{
    ...
    SLP_result->R1=1;
    SLP_result->R2=(params->Af-1)*SLP_result->R1;
...
condition SHP(input_val* params)
{
    ...
    SHP_result->R1=10;
    SHP_result->R2=(params->Af-1)*SHP_result->R1;
...
condition BPF(input_val* params)
{
   if (params==NULL){
    ...
    BPF_result->R1=(BPF_result->R2/params->Af);
